...
# ✅ ADICIONADO: EDITAR ITEM (PUT) - com validação de reserva
...
def editar_item(
    ...
    try:
        ...
        # impede baixar estoque abaixo do que já está reservado
...
# ✅ ADICIONADO: EXCLUIR ITEM (DELETE) - com proteção de item em uso
...
def imagem_item_arquivo(id_item: int, id_usuario: int = Query(...)):
    """
    Serve imagem de item a partir do filesystem.
    """
